      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Discover our innovative projects spanning urban planning, architecture, interior design, and visual identity, 
            each reflecting our commitment to bridging cultures and creating exceptional spaces.
          </p>
        </div>
